...
export default function DeleteBlogForm() {
        ...
        debounce(async (query: string) => {
            ...
            try {
                ...
                if (response.data && Array.isArray(response.data)) {
                    const results = response.data.map((blog: Blog) => ({
                        ...blog,
                        displayTitle: blog.title.length > 50 
    ...
    const handleDeleteBlog = async () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                // Remove deleted blog from search results
                setSearchResults(prev => prev.filter(blog => blog.id !== selectedBlog.id))
                // Clear selection
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-900">Delete Blog</h1>
                <p className="text-gray-600 mt-2">Search and delete blog posts</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="p-6 md:p-8">
                    <div className="space-y-8">
                        ...
                        <div>
                            <div className="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">Search for a blog by title to delete</p>
                                </div>
                            </div>
                        ...
                        {/* Search Results */}
                        {searchResults.length > 0 && !selectedBlog && (
                            <div className="mt-6">
                                            ...
                                            <div className="flex justify-between items-start">
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center text-xs text-gray-500 gap-4">
                                                        ...
                                                        <span>Images: {Array.isArray(blog.images) ? blog.images.length : 0}</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="p-6 bg-linear-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                                        <div className="flex justify-between items-start">
                                            ...
                                            <div className="text-right">
                                                <p className="text-sm text-gray-600">
                                                    Images: {Array.isArray(selectedBlog.images) ? selectedBlog.images.length : 0}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-gray-700 max-h-40 overflow-y-auto pr-2">
                                                {selectedBlog.content.length > 300 
                                                    ? selectedBlog.content.substring(0, 300) + "..."
                                                    : selectedBlog.content
                                                }
                                            </div>
                                            <p className="text-sm text-gray-500 mt-2">
                                                Total characters: {selectedBlog.content.length}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    {showConfirm ? (
                                        ...
                                        <div className="p-6 border-t border-gray-200">
                                            ...
                                            <p className="text-sm text-gray-500 text-center mt-3">
                                                Clicking this button will permanently delete the blog and all associated images.
                                            </p>
                                        </div>
                                    )}
                                </div>
                        ...
                        {/* No Results Message */}
                        {searchQuery && !isSearching && searchResults.length === 0 && !selectedBlog && (
                            <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                                <p className="text-center text-gray-700">
                                    No blogs found matching "<span className="font-semibold">{searchQuery}</span>"
                                </p>
