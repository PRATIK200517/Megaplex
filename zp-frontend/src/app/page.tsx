...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Mobile menu button */}
            <button 
              className="md:hidden text-gray-700 mobile-menu-button"
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden mobile-menu absolute top-16 left-0 right-0 bg-white shadow-lg border-t border-gray-100 z-40">
              <div className="px-4 py-2 space-y-1">
                {navItems.map((item) => (
                  <Link
                    key={item.item}
                    href={item.tgt}
                    className="block py-3 px-4 text-gray-700 hover:text-[#8E1B1B] hover:bg-gray-50 rounded-lg font-medium transition-colors"
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24 w-full">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="#user-footer">
              <button className="bg-white/90 backdrop-blur-sm text-gray-800 border border-white/20 px-8 py-4 rounded-xl font-semibold hover:bg-white hover:border-[#8E1B1B] hover:text-[#8E1B1B] transition-all duration-300 shadow-lg hover:shadow-2xl" onClick={()=>{}}>
                <div className="flex items-center justify-center gap-2" >
                  Contact Us
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
     ...
     <div id='user-footer'><UserFooter/></div>
      {/* Animation styles */}
      <style jsx>{`
        @keyframes slide-in {
          0% {
